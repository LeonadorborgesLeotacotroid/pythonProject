...
while (True):  # while sirve para validar el def
    ...
    print("PRESIONE (2) SI QUIERES SABER EL CAMPEON MAXIMO De NJPW")
    print("PRESIONE (3) SI QUIERES SABER EL CAMPEON MAXIMO DE AEW")
    print("PRESIONE (4) SI QUIERES SABER EL CAMPEON MAXIMO DE AAA")
