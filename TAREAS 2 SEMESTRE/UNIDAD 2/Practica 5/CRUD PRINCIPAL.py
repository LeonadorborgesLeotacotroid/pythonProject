...
class Alumnos:
    ...
    def llamar_maestro(self):
     ...
     call([sys.executable,'C:/pythonProject/TAREAS 2 SEMESTRE/UNIDAD 2/Practica 5/CRUD ALUMNOS.py'])#importante cambiar la dirreccion segun donde se corresponda su computadora
