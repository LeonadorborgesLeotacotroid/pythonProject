...
class VentanaPrincipal:
    def __init__(self, master):
        ...
        self.master.iconbitmap(r"c:/pythonProject/EXAMEN UNIDAD 2/icono.ico")
        ...
        #Imagen para el menú
        imagen_menu = Image.open("c:/pythonProject/EXAMEN UNIDAD 2/MENU.png")
    ...
    def llamar_horario(self):
        root.destroy()
        call([sys.executable, 'c:/pythonProject/EXAMEN UNIDAD 2/HORARIO.py'])

    def llamar_calendario(self):
        root.destroy()
        call([sys.executable, 'c:/pythonProject/EXAMEN UNIDAD 2/CALENDARIO.py'])

    def llamar_mistareas(self):
        root.destroy()
        call([sys.executable, 'c:/pythonProject/EXAMEN UNIDAD 2/MIS TAREAS.py'])
